...
BODY {
						...
						<tbody vAlign="top">
												...
												<font color="#808000" face="Calibri">
													<strong>
														<font color="#839216" face="Calibri">
															<img style="WIDTH: 118px; HEIGHT: 35px" src="6E91E6A3.gif"/>
														</font>
													</strong>
												</font>
											</strong>
							...
							<tr style="MIN-HEIGHT: 16px">
								...
								<td style="BORDER-BOTTOM: #000000 1pt; BORDER-LEFT: black 1pt; PADDING-RIGHT: 1px; VERTICAL-ALIGN: middle; BORDER-TOP: #808080 6pt; BORDER-RIGHT: #000000 1pt" colSpan="3">
									<div>
										<span class="xdExpressionBox xdDataBindingUI" title="" xd:xctname="ExpressionBox" xd:CtrlId="CTRL8" xd:disableEditing="yes" tabIndex="-1" style="WIDTH: 100%; FONT-FAMILY: Calibri">
											<xsl:value-of select="my:Admin/my:CurrentUser"/>
										</span>
									</div>
								</td>
								...
								<td style="BORDER-BOTTOM: #000000 1pt; BORDER-LEFT: #000000 1pt; PADDING-RIGHT: 1px; VERTICAL-ALIGN: middle; BORDER-TOP: #808080 6pt; BORDER-RIGHT: black 1pt" colSpan="3">
									<div align="right">
										<span class="xdExpressionBox xdDataBindingUI xdBehavior_Formatting" title="" xd:xctname="ExpressionBox" xd:CtrlId="CTRL36" xd:disableEditing="yes" xd:binding="my:SectionD/my:Cancellation/my:CancellationDate" xd:datafmt="&quot;datetime&quot;,&quot;locale:4105;dateFormat:dd-MMM-yyyy;timeFormat:none;&quot;" xd:datafmt2="calendar:1;" tabIndex="-1" style="BORDER-BOTTOM: #808080 1pt; BORDER-LEFT: #808080 1pt; FONT-STYLE: italic; WIDTH: 100%; HEIGHT: 21px; BORDER-TOP: #808080 1pt; BORDER-RIGHT: #808080 1pt">
								...
								<td style="BORDER-BOTTOM: #000000 1pt; BORDER-LEFT: black 1pt; PADDING-RIGHT: 1px; VERTICAL-ALIGN: middle; BORDER-TOP: #808080 6pt; BORDER-RIGHT: #d8d8d8 1pt solid">
									<div align="right">
										<span class="xdExpressionBox xdDataBindingUI xdBehavior_Formatting" title="" xd:xctname="ExpressionBox" xd:CtrlId="CTRL37" xd:disableEditing="yes" xd:binding="my:SectionD/my:Cancellation/my:CancellationDate" xd:datafmt="&quot;datetime&quot;,&quot;locale:4105;dateFormat:none;timeFormat:h:mm:ss tt;&quot;" xd:datafmt2="calendar:1;" tabIndex="-1" style="BORDER-BOTTOM: #808080 1pt; BORDER-LEFT: #808080 1pt; FONT-STYLE: italic; WIDTH: 100%; BORDER-TOP: #808080 1pt; BORDER-RIGHT: #000000 1pt">
											<xsl:attribute name="xd:num">
												<xsl:value-of select="my:SectionD/my:Cancellation/my:CancellationDate"/>
											</xsl:attribute>
											<xsl:choose>
							...
							<tr style="MIN-HEIGHT: 66px">
								...
								<td style="BORDER-BOTTOM: #808080 6pt; BORDER-LEFT: #7f7f7f 1pt solid; PADDING-RIGHT: 1px; VERTICAL-ALIGN: middle; BORDER-TOP: #000000 1pt; BORDER-RIGHT: #d8d8d8 1pt solid" colSpan="9">
									<div align="center">
										<input style="BACKGROUND-COLOR: #f2f2f2; MARGIN: 1px; WIDTH: 160px; FONT-FAMILY: Calibri; COLOR: #9fb01d;" class="langFont" title="" value="Confirm Cancellation" type="button" xd:xctname="Button" xd:CtrlId="CTRL20_27" tabIndex="0">
											<xsl:attribute name="style">BACKGROUND-COLOR: #f2f2f2; MARGIN: 1px; WIDTH: 160px; FONT-FAMILY: Calibri; COLOR: #9fb01d;<xsl:choose>
													<xsl:when test="my:SectionD/my:Cancellation/my:CancellationRationale = &quot;&quot;">caption: Disable Button</xsl:when>
												</xsl:choose>
											</xsl:attribute>
											<xsl:choose>
												<xsl:when test="my:SectionD/my:Cancellation/my:CancellationRationale = &quot;&quot;">
							...
							<tr style="MIN-HEIGHT: 4px">
								...
								<td style="BORDER-BOTTOM: #808080 6pt; BORDER-LEFT: #7f7f7f 1pt solid; PADDING-RIGHT: 1px; BORDER-TOP: #808080 6pt; BORDER-RIGHT: #d8d8d8 1pt solid" colSpan="9">
									<div>
												...
												<xsl:for-each select="my:SectionA/my:Attachments">
													<tr style="MIN-HEIGHT: 36px">
														<td style="BORDER-BOTTOM: #000000 1pt; BORDER-LEFT: #000000 1pt; PADDING-BOTTOM: 1px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; BORDER-TOP: #d8d8d8 1pt; BORDER-RIGHT: #000000 1pt; PADDING-TOP: 1px">
															<font face="Calibri">
																<span hideFocus="1" style="WIDTH: 150px; FONT-FAMILY: Calibri; HEIGHT: 30px" class="xdFileAttachment" xd:xctname="FileAttachment" xd:CtrlId="CTRL580" xd:binding="my:Attachment" xd:boundProp="xd:inline" tabStop="true" tabIndex="0">
										...
										<div class="optionalPlaceholder" xd:xmlToEdit="Attachments_9" tabIndex="0" xd:action="xCollection::insert" style="WIDTH: 578px">Insert item</div>
									</div>
								</td>
							</tr>
							<tr style="MIN-HEIGHT: 4px">
								...
								<td style="BORDER-BOTTOM: #bfbfbf 1pt; BORDER-LEFT: #bfbfbf 1pt solid; BACKGROUND-COLOR: #9fb01d; PADDING-RIGHT: 1px; VERTICAL-ALIGN: middle; BORDER-TOP: #808080 6pt; BORDER-RIGHT: #d8d8d8 1pt solid" colSpan="2">
									<div align="center">
										<font face="Calibri">
											<em>
												<input style="BACKGROUND-COLOR: #bfbfbf; MARGIN: 1px; WIDTH: 100%; FONT-FAMILY: Calibri; FONT-SIZE: 9pt" class="langFont" title="" value="Discard &amp; Close" type="button" xd:xctname="Button" xd:CtrlId="CTRL101" tabIndex="0"/>
											</em>
										</font>
									</div>
								</td>
								...
								<td style="BORDER-BOTTOM: #d8d8d8 1pt solid; BORDER-LEFT: #7f7f7f 1pt solid; BORDER-TOP: #bfbfbf 1pt solid; BORDER-RIGHT: #bfbfbf 1pt solid" colSpan="2">
									<div align="center">
										<button style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; MARGIN: 1px; WIDTH: 18px; HEIGHT: 21px; BORDER-TOP: medium none; BORDER-RIGHT: medium none" class="xdPictureButton" title="" contentEditable="false" xd:xctname="PictureButton" xd:CtrlId="CTRL577_5" xd:HideInPrintView="true" tabIndex="0">
											<img style="WIDTH: 100%; HEIGHT: 21px;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; POSITION: static" alt="" src="85F53BA9.png" xd:HoverSRC="FBEDB2D7.png"/>
										</button>
										<strong>
	...
	<xsl:template match="my:Cancellation" mode="_1">
		<div style="BORDER-BOTTOM: #000000 1pt; BORDER-LEFT: #000000 1pt; WIDTH: 100%; MARGIN-BOTTOM: 0px; BORDER-TOP: #000000 1pt; BORDER-RIGHT: #000000 1pt" class="xdSection xdRepeating" title="" align="left" xd:xctname="Section" xd:CtrlId="CTRL4" tabIndex="-1" xd:widgetIndex="0">
			<div align="left">
					...
					<tbody vAlign="top">
						<tr style="MIN-HEIGHT: 56px">
							<td style="BORDER-BOTTOM: #000000 1pt; BORDER-LEFT: #000000 1pt; PADDING-RIGHT: 1px; BORDER-TOP: #000000 1pt; BORDER-RIGHT: #000000 1pt">
								...
								<div>
									<span hideFocus="1" class="xdRichTextBox" title="" xd:xctname="RichText" xd:CtrlId="CTRL5" xd:binding="my:CancellationRationale" tabIndex="0" style="WIDTH: 100%; FONT-FAMILY: Calibri; HEIGHT: 50px">
